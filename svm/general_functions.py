...
def replaceCommonWords(input_string):
    words_to_replace = {'a', 'about', 'an', 'and', 'any', 'are', 'as', 'at', 'by', 'can', 'do', 'for', 'from', 'get', 'have', 'how', 'in', 'is', 'may', 'me', 'my', 'need', 'of', 'on', 'or', 'please', 'some', 'the', 'this', 'that', 'there', 'to', 'what', 'What\'s', 'where', 'you', 'please','details', 'information', 'can', 'i'}
