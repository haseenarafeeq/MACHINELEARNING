...
# Lists to store user input lengths for validation data
validation_user_input_lengths = []
...
for _ in range(100):
    ...
    validation_user_input_lengths.append(user_input_length)
...
pearson_corr, _ = pearsonr(response_times, validation_user_input_lengths)
spearman_corr, _ = spearmanr(response_times, validation_user_input_lengths)
